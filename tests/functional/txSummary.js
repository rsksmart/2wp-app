...
const TxSummary = require('../../src/components/exchange/TxSummary.vue');
const SatoshiBig = require('../../src/types/SatoshiBig');
const constants = require('../../src/store/constants');
const { EnvironmentAccessorService } = require('../../src/services/enviroment-accessor.service');

const localVue = createLocalVue();
const wrapper = shallowMount(TxSummary, { localVue, Vuetify });

console.log('xxxxxxxxxxxxxxxx', wrapper.html());
...
// })();
// await page.goto('ttps://localhost:8080/status/txId/2d21a828993f8d27487ee59ae7b72a06d7bd631a82372e2c13d2f3ce9ff49480');
