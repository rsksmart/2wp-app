...
export class EnvironmentVariables {
  ...
  constructor(defaultValues: any = {}) {
    ...
    this.vueAppWalletAddressHardStop = Number(import.meta.env.VITE_WALLET_ADDRESSES_HARD_STOP)
    ...
    this.vueAppHotjarId = import.meta.env.VITE_HOTJAR_ID || defaultValues.vueAppHotjarId;
