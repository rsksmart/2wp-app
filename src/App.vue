...
export default class App extends Vue {
  ...
  get contentSecurityPolicy(): string {
    ...
    img-src data: https:;
    connect-src 'self' 'unsafe-inline' https://*.hotjar.com https://*.hotjar.io wss://*.hotjar.com https://*.hotjar.com https://*.hotjar.io wss://*.hotjar.com ${envVariables.vueAppApiBaseUrl} ${envVariables.vueAppRskNodeHost} https://api.coingecko.com https://*.clarity.ms https://www.clarity.ms;
    object-src 'none';
