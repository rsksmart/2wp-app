...
export default {
  ...
  setup() {
    ...
    const contentSecurityPolicy = computed((): string => {
      ...
      connect-src 'self' 'unsafe-inline' https://www.google.com/recaptcha/ https://www.clarity.ms/s/0.7.16/clarity.js wss://* https://*.hotjar.com https://*.hotjar.io https://www.clarity.ms/s/* wss://*.hotjar.com ${envVariables.vueAppApiBaseUrl} ${envVariables.vueAppRskNodeHost} ${envVariables.cspConfiguration} https://api.coingecko.com/ https://*.clarity.ms https://www.clarity.ms/* https://rpc.walletconnect.com https://rpc.walletconnect.org https://relay.walletconnect.com https://relay.walletconnect.org wss://relay.walletconnect.com wss://relay.walletconnect.org https://pulse.walletconnect.com https://pulse.walletconnect.org https://api.web3modal.com https://api.web3modal.org https://public-node.testnet.rsk.co/ https://public-node.rsk.co https://mempool.space https://connect.trezor.io http://127.0.0.1:21325 https://127.0.0.1:21325 ws://127.0.0.1:21325 wss://127.0.0.1:21325 ws://127.0.0.1:21335 wss://127.0.0.1:21335;
      object-src 'none';
