import {
  ExodusTx, NormalizedInput, NormalizedTx, PsbtExtendedInput,
} from '@/common/types';
import * as bitcoin from 'bitcoinjs-lib';
import { ApiService } from '@/common/services';
import TxBuilder from './TxBuilder';

export default class ExodusTxBuilder extends TxBuilder {
  buildTx(normalizedTx: NormalizedTx): Promise<ExodusTx> {
    return new Promise<ExodusTx>((resolve, reject) => {
